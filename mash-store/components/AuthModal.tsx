...
export function AuthModal({ mode, onClose, onLogin, switchMode }: Props) {
  ...
  return (
    <div className="modal-overlay" onClick={(e) => e.target === e.currentTarget && onClose()}>
      <div className="modal">
        ...
        <p className="modal-sub">{mode === "login" ? "Log in or sign up with OAuth" : "Create your account with OAuth or email"}</p>
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 10, margin: "16px 0", color: "var(--text2)", fontSize: 12 }}>
